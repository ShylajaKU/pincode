...
<textarea class="form-control me-2" name="question" cols="10" rows="5" placeholder="Question"></textarea>

<br>
<input  class="form-control me-2" type="text" name="answer" placeholder="Answer" required>
<br>
